...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문 가격은 가격x수량이다.", 10000 * orderCount, getOrder.getTotalPrice());
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문이 취소된 상태는 재고가 증가(원복)해야한다.", 10, item.getStockQuantity());
    }
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "강가","123-12324232"));
        em.persist(member);
        return member;
    }
